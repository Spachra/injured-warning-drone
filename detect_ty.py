...
def run(weights=ROOT / 'yolov5s.pt',  # model.pt path(s)
    ...
    for path, img, im0s, vid_cap, s in dataset:
        ...
        for i, det in enumerate(pred):  # per image
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or save_crop or view_img:  # Add bbox to image
                        ...
                        print( names[c], conf ) #เติมมา
                        #if names[c] == 'Need Help' or 'Emergency' :
                        #if conf < 0.7 :
            ...
            # Stream results
            im0 = annotator.result() #im0คือตัวแปรที่เป็นรูปภาพ รูปที่ดีเทคแล้ว โค้ดเดิม
            ...
            if view_img:
                ...
                #แกะโค้ด cv2.imshow(ชื่อไฟล, ตัวแปรรูป)
